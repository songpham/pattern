<?php
/**
 * Vậy factory_method là gọi thằng class cha, class cha có khả năng build, việc ta cần làm là thảy công cụ vào cho class cha để class cha build và return về product ngay. Ví dụ class thực thi một tác vụ nào đó như class connect database.
 */
