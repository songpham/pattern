<?php
/**
 * Vậy abstract_factory là gọi thằng class cha, class cha có khả năng build ra gì thì build ra cái đó và return về product ngay. Ví dụ class thực thi một tác vụ nào đó như curl.
 */
/*
 * BookFactory classes
 */
