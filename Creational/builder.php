<?php
/**
 * Vậy builder là gọi thằng class con, nhúng thằng cha vào, dựa vào các khả năng của class cha, class con có thể build ra tùy ý và return về product ở step cuối cùng. Ví dụ class model
 */
